...
Where [post 1](https://ben-heil.github.io/2020-06-16-mustdo/) and [post 2](https://ben-heil.github.io/2020-06-30-shoulddo/) had suggestions for making your code more likely to be reproducible, some of the ideas in this post make the work easier to reproduce.
...
The second half ([Continuous Integration](#ci) to [Linux Package Management](#guix)) is about useful tools.
...
Instead of doing this testing just once, you can write down the test in a function called a test case and run them after each code change.
...
You would then write a regression test that ensures the original and reverse complement sequence have the same length.
...
The choice between the two is whether you would rather have more flexibility with pylint or never have to worry about anything style related with Black.
