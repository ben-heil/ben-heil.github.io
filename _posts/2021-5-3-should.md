...
A typical lecture class looks more like "your professor explains a concept -> weeks pass -> you write down the concept on a sheet of paper titled 'Exam'".
Can you imagine stopping a lecture to say "how do you know that's true", or "have other people replicated that finding?"
The reason that idea is so outlandish is because science coursework is designed to convey information that other scientists have already discovered, not to show you how to do science yourself.

As a PhD student you get to find your own answers.
