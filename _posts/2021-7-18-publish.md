...
TODO don't use publication and journal interchangeably; pick one
...
The publisher then give other scientists (called reviewers) [internet points](https://publons.com/about/home/) to determine whether it is worth their time to publish.
...
**Paper Ownership**  
When a paper is published in closed-access journals, the journal owns[^owns] the paper.
...
The journal still keeps the copyright, of course, so [only a subset](https://www.ncbi.nlm.nih.gov/pmc/tools/openftlist/) of published articles are available for future research.
...
TODO elaborate
There is a [movement](https://jamesheathers.medium.com/the-450-movement-1f86132a29bd) dedicated to pushing back against unpaid peer review.
