...
Journals also coordinate peer review.
For all that I believe that "is this paper good enough for X journal" isn't a good framing for peer review, I do believe that peer review is a valuable scientific process.


## Alternatives

TODO structure this based on the role in the previous section each thing fills
