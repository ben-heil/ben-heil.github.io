...
During this time the research is done and the paper is written, but unless the paper is preprinted no one other than the authors, reviewers, and the publisher can read it[^preprints].
...
In addition flaws in pricing, there are also issues with the current framing of peer review.
...
Another, less-discussed, externalized cost of the modern publication system is the increased risk to the scientific record.
...
### Platforms  
While in the past the only way for scientists to disseminate work was through journals, letters, or conferences, the internet has made distribution much easier.
...
Though I don't think the format is actually healthy for communicating science (or anything for that matter), it is effective at transmitting ideas to a large number of people[^twitter].
...
Because of its conference-based system and the fast pace of progress, scientists in deep learning are reliant on preprints in a field that posts hundreds per day.
...
My guess is that the future will be made up of several different manual and automatic systems, driven by popularity and suitability for particular uses.

**Peer review**  
Although peer review is a useful signal about a paper's quality[^yelp], in its [current form](https://www.youtube.com/watch?v=lt_b4VKBDhI) it is inefficient and misaligned with the goals of science.
...
You could even imagine a system where grad students looking to gain domain knowledge and augment their stipends could peer review papers rather than teaching classes.
...
Meanwhile, [Publons](https://publons.com/about/home/) knows who has reviewed for which journals, but not the scores they gave or the content of the reviews.
...
The internet gives us the ability to make notes available to to the entire world with little friction.
Now that distribution costs are negligible, it is no longer infeasible to maintain a repository of null results.
Simple signposts of the form "I tried X, but it didn't work. Here's my code and experimental description" could save huge amounts of scientist labor by cautioning people away from known pitfalls.
...
Right now students are told to read papers and guess at why authors did what they did.
...
[^twitter]: Some day I want to run an experiment by purchasing a Twitter ad for the same price as an article publication fee and see whether the journal or the ad gets more people to read the paper. I suspect it would be the latter.
