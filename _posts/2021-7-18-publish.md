...
[Several](https://arxiv-sanity-lite.com/about) [natural language processing](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0158423) [methods](elicit.org) exist for finding and aggregating papers.
...
The current incarnation of peer review asks "is this paper good[^good] enough to be published in this journal", while it should ask "_how_ good[^good] is this paper?"
