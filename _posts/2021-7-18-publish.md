...
The present-day academic publication system is inefficient, and the [costs](https://twitter.com/DGlaucomflecken/status/1484679759829209090) of this inefficiency are primarily borne by scientists.
...
Of course, the publisher still keeps the copyright, so [only a subset](https://www.ncbi.nlm.nih.gov/pmc/tools/openftlist/) of published articles are available for future research.
...
As a result, the "official" scientific progress rate is slowed down by months.
...
### Platforms  
While in the past the only way for scientists to disseminate work was through journals, letters, or conferences, the internet has made distribution much more accessible.
...
While preprint servers don't necessarily have the same cultural prestige as major journals, removing the barrier to actually reading the work in question expands what is possible.
...
You can see more creative views of science publication off the beaten path.
...
Currently, this platform is tied to individual conferences; works are submitted to a conference and reviewed/accepted/rejected by people affiliated with the conference.
...
Each journal knows the tone and quality of individuals' reviews, but there are so many journals that it is challenging to get an idea of reviewers' calibration[^calibration].
...
Students are currently told to read papers and guess why authors did what they did.
...
If you don't like getting emails from random people on the internet about how you're wrong and should give them money, maybe you'd feel more comfortable with someone you know doing it.
