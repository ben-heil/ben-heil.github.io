...
That's not to imply that this is a bad study design.
...
This article describe what PLIER is, how PLIER works, and some potential applications described in the [MultiPLIER](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6538307/) paper.
...
The application of PLIER that I think is most interesting is to use it to learn signals from big datasets and apply them to smaller datasets.
...
2. You can train a PLIER model on a huge compendium of expression data and do as well or better than a model trained on a tissue-specific dataset
