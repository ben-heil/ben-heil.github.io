...
This article describes what PLIER is, how PLIER works, and some potential applications described in the [MultiPLIER](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6538307/) paper.
...
### Pathways
While it can be helpful to describe gene expression in a small number of variables, what variables you use is critical.
...
In the next section, I'll [go into more detail](#pathway) to explain how they accomplish that.
...
2. You can train a PLIER model on a compendium of expression data and do as well or better than a model trained on a tissue-specific dataset
