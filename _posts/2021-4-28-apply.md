...
If you want to decide whether you enjoy the computational biology problem space, you might be interested in the [GCB Summer CompBio Preview](https://twitter.com/JeneaIA/status/1372622558659510279).
...
Getting a volunteer position in a particular lab is probably easier than getting a paid one since you'd have to apply at the same time that that lab is hiring to get a paid position.
...
First, if you have a specific topic you want to research, there may not be many schools with faculty doing research.
