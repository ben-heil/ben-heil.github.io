...
[Galaxy](https://usegalaxy.org/) has a more limited scope, but is useful if you would rather work in a graphical environment than with scripts.
...
I would often sink huge amounts of time into trying to remember what exactly the `add_data` function did instead of spending that time doing useful work.
